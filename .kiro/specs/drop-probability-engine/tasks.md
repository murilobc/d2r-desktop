...
- [x] 1. Create probability_engine Rust module with TC data structures
  - [x] 1.1 Create `src-tauri/src/probability_engine.rs` with data model structs and TC data loading
  ...
  - [x] 1.2 Create placeholder `src-tauri/data/tc_data.json` with schema and sample entries
...
- [x] 2. Implement core probability computation algorithms
  - [x] 2.1 Implement TC tree traversal (`compute_item_probability`)
  ...
  - [x] 2.2 Implement MF adjustment and player count formulas
  ...
  - [x] 2.3 Implement cumulative distribution and luck percentile functions
  ...
  - [x] 2.4 Write property tests for MF adjustment monotonicity and rune immunity
  ...
  - [x] 2.5 Write property tests for player count and quest bonus
  ...
  - [x] 2.6 Write property tests for TC traversal and cumulative distribution
...
- [x] 3. Implement Terror Zone and Herald TC modifications
  - [x] 3.1 Implement Terror Zone TC elevation logic
...
- [x] 4. Expose Tauri commands for the probability engine
  - [x] 4.1 Create `calculate_drop_probability` and `calculate_cumulative_distribution` commands
  ...
  - [x] 4.2 Create `get_area_run_stats` and `calculate_luck_percentile` commands
  ...
  - [x] 4.3 Write property tests for luck percentile and input validation
...
- [x] 5. Checkpoint - Ensure Rust backend compiles and tests pass
  - Run `cd src-tauri && cargo check` and `cargo test`
  - Ensure all tests pass, ask the user if questions arise.

- [x] 6. Add frontend API bindings for probability commands
  - [x] 6.1 Add TypeScript interfaces and invoke wrappers in `src/api.ts`
...
- [x] 7. Implement the upgraded DropCalculator page with 3-tab layout
  - [x] 7.1 Refactor `src/pages/DropCalculator.tsx` with 3-tab structure
  ...
  - [x] 7.2 Implement ProbabilityTab component
  ...
  - [x] 7.3 Implement DistributionChart with Recharts AreaChart
  ...
  - [x] 7.4 Implement RunEstimate section
  ...
  - [x] 7.5 Implement ComparisonTab with expected-vs-actual chart
  ...
  - [x] 7.6 Implement LuckGauge percentile display
...
- [x] 8. Add i18n translation keys for the drop probability page
  - [x] 8.1 Add translation keys to `src/i18n/locales/en-US.json`, `pt-BR.json`, and `es.json`
...
- [x] 9. Checkpoint - Ensure frontend compiles and tests pass
  - Run `npx tsc --noEmit` and `npm test`
  - Ensure all tests pass, ask the user if questions arise.

- [x] 10. Write frontend component tests
  - [x] 10.1 Write Vitest tests for ProbabilityTab
  ...
  - [x] 10.2 Write Vitest tests for ComparisonTab and LuckGauge
  ...
  - [x] 10.3 Write property tests for frontend probability formatting
