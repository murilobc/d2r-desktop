...
- [x] 1. Create advisor engine module with core data models and computation functions
  - [x] 1.1 Create `src/advisor/advisor-engine.ts` with type definitions and `computeAreaRankings`
  ...
  - [x] 1.2 Implement `computeWeeklySummary` in `advisor-engine.ts`
  ...
  - [x] 1.3 Implement `detectDiminishingReturns` in `advisor-engine.ts`
  ...
  - [x] 1.4 Implement `computeTZRecommendation` in `advisor-engine.ts`
  ...
  - [x] 1.5 Implement `computeBuildSuggestions` in `advisor-engine.ts`
...
- [x] 2. Write property-based tests for advisor engine
  - [x] 2.1 Write property test: Area efficiency metrics computation
  ...
  - [x] 2.2 Write property test: Rankings sorted descending
  ...
  - [x] 2.3 Write property test: Minimum run threshold
  ...
  - [x] 2.4 Write property test: Diminishing returns trigger
  ...
  - [x] 2.5 Write property test: Alternative excludes flagged area
  ...
  - [x] 2.6 Write property test: Weekly window filtering
  ...
  - [x] 2.7 Write property test: TZ recommendation threshold
    - **Property 7: Terror Zone recommendation threshold**
    - isRecommended = true iff (tzVPH - globalAvg) / globalAvg >= 0.10
    - **Validates: Requirements 5.1, 5.2**

  - [x] 2.8 Write property test: Build filtering prioritizes above-average areas
  ...
  - [x] 2.9 Write property test: Sorceress cold-immune annotation
  ...
  - [x] 2.10 Write property test: Weekly summary aggregates consistency
...
- [x] 4. Add i18n keys for the Advisor page
  - [x] 4.1 Add `advisor.*` translation keys to all 3 locale files
...
- [x] 5. Implement Advisor page and sub-components
  - [x] 5.1 Create `src/components/WeeklySummaryCard.tsx`
  ...
  - [x] 5.2 Create `src/components/TerrorZoneRecommendation.tsx`
  ...
  - [x] 5.3 Create `src/components/DiminishingReturnsAlert.tsx`
  ...
  - [x] 5.4 Create `src/components/AreaRankingTable.tsx`
  ...
  - [x] 5.5 Create `src/components/BuildSuggestions.tsx`
  ...
  - [x] 5.6 Create `src/pages/Advisor.tsx` page component
...
- [x] 6. Integrate Advisor page into application navigation
  - [x] 6.1 Add Advisor route to `src/App.tsx`
...
- [x] 8. Write unit tests for Advisor page and components
  - [x] 8.1 Write unit tests for `Advisor.tsx` page
  ...
  - [x] 8.2 Write unit tests for sub-components
  ...
  - [x] 8.3 Write unit tests for navigation and i18n integration
