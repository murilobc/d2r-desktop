...
- [x] 1. Create static game data files
  - [x] 1.1 Create `src/data/runes.ts` with all 33 rune definitions
  ...
  - [x] 1.2 Create `src/data/runewords.ts` with all ~99 runeword recipes
  ...
  - [x] 1.3 Write unit tests for static data integrity
...
- [x] 2. Implement pure logic modules
  - [x] 2.1 Create `src/lib/eligibility-engine.ts`
  ...
  - [x] 2.2 Write property test for eligibility classification (Property 4)
  ...
  - [x] 2.3 Write property test for progress calculation (Property 5)
  ...
  - [x] 2.4 Create `src/lib/cube-engine.ts`
  ...
  - [x] 2.5 Write property test for cube upgrade path (Property 6)
  ...
  - [x] 2.6 Write property test for inventory reduces cube cost (Property 7)
...
- [x] 4. Implement Rust backend (SQLite tables + Tauri commands)
  - [x] 4.1 Add database migration for `rune_inventory` and `runeword_targets` tables
  ...
  - [x] 4.2 Implement rune inventory Tauri commands in `src-tauri/src/commands.rs`
  ...
  - [x] 4.3 Implement runeword target Tauri commands
  ...
  - [x] 4.4 Register new commands in Tauri app builder
    - Add all 6 new commands to the `invoke_handler` in `src-tauri/src/main.rs`
    - _Requirements: 1.6, 5.5_

  - [x] 4.5 Write Rust unit tests for rune inventory commands
...
- [x] 6. Add TypeScript types and API bindings
  - [x] 6.1 Add `RuneCount` and `RunewordTarget` types to `src/types.ts`
...
- [x] 7. Implement React UI components
  - [x] 7.1 Create `src/components/RuneGrid.tsx`
  ...
  - [x] 7.2 Create `src/components/EligibilityList.tsx`
  ...
  - [x] 7.3 Create `src/components/ProgressView.tsx`
  ...
  - [x] 7.4 Create `src/components/CubeCalculator.tsx`
  ...
  - [x] 7.5 Create `src/pages/RunewordPlanner.tsx` page component
...
- [x] 8. Wire navigation and lazy loading
  - [x] 8.1 Add lazy import and route for RunewordPlanner in `src/App.tsx`
...
- [x] 9. Checkpoint - UI rendering verification
  - Ensure all tests pass, ask the user if questions arise.

- [x] 10. Implement auto-increment/decrement integration with item log
  - [x] 10.1 Add rune auto-sync logic to item creation and deletion flows
  ...
  - [x] 10.2 Write property test for rune name parsing (Property 2)
  ...
  - [x] 10.3 Write property test for auto-sync (Property 3)
  ...
  - [x] 10.4 Write property test for inventory operations (Property 1)
...
- [x] 11. Extend cloud sync for rune data
  - [x] 11.1 Add rune inventory and runeword targets to sync payload
  ...
  - [x] 11.2 Write property test for sync serialization round-trip (Property 9)
...
- [x] 12. Add internationalization support
  - [x] 12.1 Add i18n keys for runeword planner to all 3 locale files
