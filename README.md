...
| Platform | Installer |
|----------|-----------|
| Windows (.exe) | [d2r-desktop_2.1.0_x64-setup.exe](https://github.com/murilobc/d2r-desktop/releases/latest/download/d2r-desktop_2.1.0_x64-setup.exe) |
| Windows (.msi) | [d2r-desktop_2.1.0_x64_en-US.msi](https://github.com/murilobc/d2r-desktop/releases/latest/download/d2r-desktop_2.1.0_x64_en-US.msi) |
