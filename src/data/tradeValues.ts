// Trade value estimates sourced from diablo2.io community price data.
// This file is fully self-contained — no imports from other data modules.
...
export const SOURCE_ATTRIBUTION = "Values based on diablo2.io price data as of 2025-07-01";
...
/**
 * Returns the trade value entry for the given item name, or null if not found.
 * This function is pure and deterministic — same input always returns same output.
 */
